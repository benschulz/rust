...
pub fn around_single_bound_ref() -> &'static (dyn Trait) { //~ ERROR unnecessary parentheses around type
    panic!()
}
...
pub fn around_single_bound_ptr() -> *const (dyn Trait) { //~ ERROR unnecessary parentheses around type
    panic!()
}

pub fn around_multi_bound_dyn_fn_output()
-> &'static dyn FnOnce() -> (impl Send + Sync) {
    &|| ()
}

pub fn around_single_bound_dyn_fn_output() -> &'static dyn FnOnce()
-> (impl Send) { //~ ERROR unnecessary parentheses around type
    &|| ()
}

pub fn around_dyn_fn_output_given_more_bounds()
-> &'static (dyn FnOnce() -> (impl Send) + Sync) {
    &|| ()
}
...
pub fn around_single_bound_impl_fn_output()
-> impl FnOnce() -> (impl Send) { //~ ERROR unnecessary parentheses around type
    || ()
}

pub fn around_impl_fn_output_given_more_bounds()
-> impl FnOnce() -> (impl Send) + Sync {
    || ()
}

pub fn around_dyn_bound() -> &'static dyn (FnOnce()) { //~ ERROR unnecessary parentheses around type
    &|| ()
}

pub fn around_impl_trait_bound() -> impl (FnOnce()) { //~ ERROR unnecessary parentheses around type
    || ()
}
